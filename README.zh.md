...
`0.1.2` 增加了自动供应链校验，并发布于 [Chhlafiu4312/promptwall](https://github.com/Chhlafiu4312/promptwall)。Release tarball 同时提供 SHA-256 校验文件和 GitHub 构建来源证明。包仍保持 `private: true`，构建过程不会发布到 npm。
