/**
 * Package-owned invariant companion for `dsh-promptwall`.
 * @module dsh-promptwall/invariant
 */

import type { Context } from '@deepseek-ai/cordis'

const PACKAGE_NAME = 'dsh-promptwall'
...
export const name = 'promptwall-invariant'
/** Service required before the companion can reserve package ownership. */
export const inject = ['invariants']

/**
 * No runtime invariant: PromptWall transforms individual tool executions but
 * owns no durable event sequence or mutable cross-call relationship.
 */
